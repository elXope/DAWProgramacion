...
public class MailTest {
    public static void main(String[] args) {
        ...
        laia.sendMailItem("Javi","Me cago en tus muertos", "Mira javi o haces el trabajo o mañana cuado te vea te dare una nyescla que te dejare la boca tuerta de por vida.\nSi ya me caias mal ahora peor.\nLaia.");
